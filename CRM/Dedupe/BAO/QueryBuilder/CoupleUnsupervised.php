...
/**
 * Class CRM_Dedupe_BAO_QueryBuilder_CoupleUnsupervised
 */
class CRM_Dedupe_BAO_QueryBuilder_CoupleUnsupervised extends CRM_Dedupe_BAO_QueryBuilder {
...
WHERE  contact1.contact_type='Couple'
AND    contact2.contact_type='Couple'
AND    " . self::internalFilters($rg);
